        ...
        <View style={styles.deviceFrame}>
          ...
          >
            ...
            <View style={styles.pageTitleSection}>
              <View>
                <Text style={styles.pageTitle}>Cadastro Técnico</Text>
            ...
            {/* BOTÃO CONTINUAR -> VAI PARA ETAPA 3 */}
            <TouchableOpacity 
              style={styles.continueButton} 
              activeOpacity={0.8}
              onPress={() => navigation.navigate("ContCadastroServios3")}
            >
...
export default ContCadastroServios2;